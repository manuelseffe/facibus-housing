...
@section('content')
  <div class="dashboard__top flexMe">
    <div class="welcomeUser">Welcome, <strong>Abdul!</strong> <img class="WelcomeImages"
        src="{{ asset('img/Emoji.svg') }}" alt=""></div>
  ...
  <div class="jamboard">
    ...
    <div class="jamboard-e">
      <div class="dashboard__steps">
        ...
        <p>You are almost there. Finish setting up your account to enable put in your first request and<br>seamlessly
          use pelow</p>
      </div>
