        ...
        <div class="dashboard">
            <div class="dashboard__sidebar">
                ...
                <div class="dashboard__sidebar-dashboard-menu">
                    <ul class="navigation">
                        <li class="navigation__list active"><a href="#" class="navigation__item"><i class="fa fa-dashboard"></i>   Overview</a></li>
                        <li class="navigation__list"><a href="#" class="navigation__item"><i class="fa fa-dashboard"></i>   Wallet</a></li>
                        <li class="navigation__list"><a href="#" class="navigation__item"><i class="fa fa-dashboard"></i>   Notification</a></li>
                        <li class="navigation__list"><a href="#" class="navigation__item"><i class="fa fa-dashboard"></i>   Settings</a></li>
                    </ul>
                </div>
